...
| [ADR-002](ADR-002-cqrs-scope-order.md) | Apply CQRS Only to order | Accepted |
...
| [ADR-006](ADR-006-database-per.md) | Database-per-Service with No Shared Tables | Accepted |
