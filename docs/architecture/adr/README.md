...
| [ADR-004](ADR-004-istio-service-mesh.md) | Use Istio Service Mesh Instead of Application-Level Resilience Libraries | Accepted |
...
| [ADR-008](ADR-008-shared-events-versioning.md) | shared-events SDK versioning: SemVer + mandatory CHANGELOG + namespace isolation | Accepted |
